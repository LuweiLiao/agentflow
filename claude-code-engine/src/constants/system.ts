...
const DEFAULT_PREFIX = `You are AgentFlow-Code, an interactive AI coding assistant.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are AgentFlow-Code, an interactive AI coding assistant, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX = `You are a Claude agent, built on AgentFlow's Claude Agent SDK.`
