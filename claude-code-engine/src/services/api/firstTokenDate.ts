...
/**
 * Fetch the user's first AgentFlow-Code token date and store in config.
 * This is called after successful login to cache when they started using AgentFlow-Code.
 */
