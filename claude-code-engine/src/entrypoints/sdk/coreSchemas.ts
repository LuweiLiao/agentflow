  ...
  z
    .object({
      ...
      apiProvider: z
        ...
        .optional()
        .describe(
          'Active API backend. AgentFlow OAuth login only applies when "firstParty"; for 3P providers the other fields are absent and auth is external (AWS creds, gcloud ADC, etc.).',
        ),
    })
