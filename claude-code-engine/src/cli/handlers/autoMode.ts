...
const CRITIQUE_SYSTEM_PROMPT =
  'You are an expert reviewer of auto mode classifier rules for AgentFlow-Code.\n' +
  '\n' +
  'AgentFlow-Code has an "auto mode" that uses an AI classifier to decide whether ' +
