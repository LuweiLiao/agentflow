...
export function CondensedLogo(): ReactNode {
  ...
  // Truncate version to fit within available width, accounting for "AgentFlow-Code v" prefix
    ...
    <OffscreenFreeze>
      <Box flexDirection="row" gap={2} alignItems="center">
        ...
        <Box flexDirection="column">
          <Text>
            <Text bold>AgentFlow-Code</Text> <Text dimColor>v{truncatedVersion}</Text>
          </Text>
          {shouldSplit ? (
            <>
