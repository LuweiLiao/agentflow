...
// Always ask when AgentFlow-Code tries to edit its own config files
 ...
 * This is a per-user temporary directory used by AgentFlow-Code for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by AgentFlow-Code)
