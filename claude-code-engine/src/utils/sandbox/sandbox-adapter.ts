...
/**
 * Resolve AgentFlow-Code-specific path patterns for sandbox-runtime.
 *
 * AgentFlow-Code uses special path prefixes in permission rules:
...
/**
 * Convert AgentFlow-Code settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where AgentFlow-Code started)
