...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when AgentFlow-Code was first started on this machine
  ...
  // AgentFlow-Code usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first AgentFlow-Code OAuth token
  ...
  // AgentFlow-Code hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
