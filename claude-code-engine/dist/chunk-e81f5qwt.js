...
async function selectEngine() {
  if (process.platform === "win32") {
    const { DetachedEngine: DetachedEngine2 } = await import("./chunk-a99kht3a.js");
    return new DetachedEngine2;
  }
  const { TmuxEngine } = await import("./chunk-ysw4khtc.js");
  const tmux = new TmuxEngine;
  if (await tmux.available()) {
    return tmux;
  }
  const { DetachedEngine } = await import("./chunk-a99kht3a.js");
...
//# sourceMappingURL=chunk-e81f5qwt.js.map
