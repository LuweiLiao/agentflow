  ...
  async function getMachineId() {
    if (!getMachineIdImpl) {
      switch (process2.platform) {
        case "darwin":
          getMachineIdImpl = (await import("./chunk-ybk37qp9.js").then((m)=>__toESM(m.default))).getMachineId;
          break;
        case "linux":
          getMachineIdImpl = (await import("./chunk-23h69r5b.js").then((m)=>__toESM(m.default))).getMachineId;
          break;
        case "freebsd":
          getMachineIdImpl = (await import("./chunk-2j875eq6.js").then((m)=>__toESM(m.default))).getMachineId;
          break;
        case "win32":
          getMachineIdImpl = (await import("./chunk-xf4fzms8.js").then((m)=>__toESM(m.default))).getMachineId;
          break;
        default:
          getMachineIdImpl = (await import("./chunk-dhhd7dtc.js").then((m)=>__toESM(m.default))).getMachineId;
          break;
      }
    }
...
//# debugId=523C1216ADABC82764756E2164756E21
//# sourceMappingURL=chunk-40t1d75v.js.map
