...
var import_client2, import_property_provider2, import_shared_ini_file_loader, isAssumeRoleProfile = (arg, { profile = "default", logger } = {}) => {
  ...
  if (!options.roleAssumer) {
    const { getDefaultRoleAssumer } = await import("./chunk-zfz9yjx2.js").then((m)=>__toESM(m.default,1));
...
var init_LoginCredentialsFetcher = __esm(() => {
  ...
  LoginCredentialsFetcher = class LoginCredentialsFetcher {
    ...
    async refresh(token) {
      const { SigninClient, CreateOAuth2TokenCommand } = await import("./chunk-emt9q9nk.js").then((m)=>__toESM(m.default,1));
...
//# sourceMappingURL=chunk-gde62b7m.js.map
