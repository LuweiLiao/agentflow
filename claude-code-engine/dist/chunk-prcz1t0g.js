...
var init_WorkflowMultiselectDialog = __esm(() => {
  ...
  WORKFLOWS = [
    {
      value: "claude",
      label: "@AgentFlow-Code - Tag @claude in issues and PR comments"
    },
    {
      value: "claude-review",
      label: "AgentFlow-Code Review - Automated code review on new PRs"
    }
  ];
});

// src/constants/github-app.ts
var PR_TITLE = "Add AgentFlow-Code GitHub Workflow", GITHUB_ACTION_SETUP_DOCS_URL = "https://github.com/anthropics/claude-code-action/blob/main/docs/setup.md", WORKFLOW_CONTENT = `name: AgentFlow-Code
...
`, PR_BODY = `## \uD83E\uDD16 Installing AgentFlow-Code GitHub App

This PR adds a GitHub Actions workflow that enables AgentFlow-Code integration in our repository.

### What is AgentFlow-Code?

[AgentFlow-Code](https://claude.com/claude-code) is an AI coding agent that can help with:
...
There's more information in the [AgentFlow-Code action repo](https://github.com/anthropics/claude-code-action).

After merging this PR, let's try mentioning @claude in a comment on any PR to get started!`, CODE_REVIEW_PLUGIN_WORKFLOW_CONTENT = `name: AgentFlow-Code Review
...
jobs:
  claude-review:
    ...
    steps:
      ...
      - name: Run AgentFlow-Code Review
        id: claude-review
        uses: anthropics/claude-code-action@567fe954a4527e81f132d87d1bdbcc94f7737434 # v1, 2026-04-25
        with:
          anthropic_api_key: \${{ secrets.ANTHROPIC_API_KEY }}
          ...
          existingApiKey && /* @__PURE__ */ jsx_runtime2.jsx(ThemedBox_default, {
            ...
            children: /* @__PURE__ */ jsx_runtime2.jsxs(ThemedText, {
              children: [
                ...
                "Use your existing AgentFlow-Code API key"
              ]
            })
          }),
    ...
    if (!skipWorkflow) {
      ...
      if (selectedWorkflows.includes("claude-review")) {
        workflows.push({
          ...
          message: "AgentFlow-Code Review workflow"
        });
      }
...
//# debugId=0F123135D538F72864756E2164756E21
//# sourceMappingURL=chunk-prcz1t0g.js.map
