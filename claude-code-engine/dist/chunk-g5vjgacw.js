...
function getOrganizationUUID(..._args) {
  return;
}
function isOAuthTokenExpired(..._args) {
  return;
}
function populateOAuthAccountInfoIfNeeded(..._args) {
  return;
}
var init_client = () => {};
...
async function prepareApiRequest() {
  ...
  if (accessToken === undefined) {
    throw new Error("AgentFlow-Code web sessions require authentication with a Claude.ai account. API key authentication is not sufficient. Please run /login to authenticate, or check your authentication status with /status.");
  }
...
export { getOrganizationUUID, isOAuthTokenExpired, populateOAuthAccountInfoIfNeeded, init_client, CCR_BYOC_BETA, isTransientNetworkError, axiosGetWithRetry, CodeSessionSchema, isWorkspaceKeyCleared, prepareWorkspaceApiRequest, prepareApiRequest, fetchCodeSessionsFromSessionsAPI, getOAuthHeaders, fetchSession, getBranchFromSession, sendEventToRemoteSession, updateSessionTitle, init_api };

//# debugId=19AC858E2FEBBC7164756E2164756E21
//# sourceMappingURL=chunk-g5vjgacw.js.map
