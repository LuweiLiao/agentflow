...
var import_client2, import_property_provider2, import_shared_ini_file_loader, isAssumeRoleProfile = (arg, { profile = "default", logger } = {}) => {
  ...
  if (!options.roleAssumer) {
    const { getDefaultRoleAssumer } = await import("./chunk-yerk8z8a.js").then((m)=>__toESM(m.default,1));
...
var init_LoginCredentialsFetcher = __esm(() => {
  ...
  LoginCredentialsFetcher = class LoginCredentialsFetcher {
    ...
    async refresh(token) {
      const { SigninClient, CreateOAuth2TokenCommand } = await import("./chunk-j54917vp.js").then((m)=>__toESM(m.default,1));
...
var import_client6, resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
  const { fromSSO } = await import("./chunk-ysg9y2aq.js");
  return fromSSO({
    profile,
...
//# sourceMappingURL=chunk-pvzh6qgc.js.map
