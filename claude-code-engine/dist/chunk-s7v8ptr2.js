...
To use voice mode, run AgentFlow-Code locally instead.`
    };
  }
  const napi = await loadAudioNapi();
  if (napi.isNativeAudioAvailable()) {
...
WSL2 with WSLg (Windows 11) provides audio via PulseAudio \u2014 if you are on Windows 10 or WSL1, run AgentFlow-Code in native Windows instead.`;
  if (process.platform === "linux" && hasCommand("arecord")) {
...
//# debugId=6035C6F03E678C5D64756E2164756E21
//# sourceMappingURL=chunk-s7v8ptr2.js.map
