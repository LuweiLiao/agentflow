...
function useVoice({
    ...
    finalizePromise.then(async (finalizeSource) => {
      ...
      if (text) {
        ...
        if (!wsConnected) {
          ...
          onErrorRef.current?.("No audio detected from microphone. Check that the correct input device is selected and that AgentFlow-Code has microphone access.");
        } else {
  ...
  import_react.useEffect(() => {
    if (enabled && !voiceModule) {
      import("./chunk-s7v8ptr2.js").then((mod) => {
        voiceModule = mod;
      });
    }
  }, [enabled]);
...
//# debugId=262E83CEB25E935564756E2164756E21
//# sourceMappingURL=chunk-t9pr4vdv.js.map
